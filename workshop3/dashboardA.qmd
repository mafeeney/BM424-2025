---
title: "Group A Hospital Dashboard"
format:
  dashboard
---

```{r dashboardA, include=FALSE}
...
```{r}
#| content: valuebox
#| title: "Average number of admissions to A&E (monthly)"
list(
...
```{r}
#| content: valuebox
#| title: "Average % of patients waiting >4 hours in A&E"
list(
  icon = "hourglass", 
...
```{r}
#| content: valuebox
#| title: "Ambulance response times (minutes)"
list(
  icon = "clock", 
...
```{r}
#| content: valuebox
#| title: "% of patients waiting <62 days for  referral (any)"
list(
  icon = "calendar3", 
...
```{r}
#| content: valuebox
#| title: "% of patients waiting <62 days for cancer treatment"
list(
...
```{r}
#| content: valuebox
#| title: "Number of patients waiting for elective surgery"
list(
  icon = "calendar3-week",
  color = "info",
  value = elecwait
