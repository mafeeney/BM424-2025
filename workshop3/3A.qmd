...
## Data Collected for the Pandemic Response Committee Meeting

{{< include _includes/data.qmd >}}

* You can find more key information about the main hospital in `r city_name`, the `r hosp_name` in the dashboard below.

{{< include _includes/dashboardA.qmd >}}
