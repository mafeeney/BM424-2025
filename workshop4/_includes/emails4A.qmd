...
<b>To:</b> pandemic_response@`r city_name`.co.uk <br>
<b>Cc:</b> <br>
<b>Subject:</b> Is Nothing Sacred Anymore
...
Now you are trying to say that in the name of "public health" we can't even garden? I have seen the scare-mongering signs on the compost sold in the garden centres and I must say, I find myself completely impressed by the sheer unmitigated bloody gall of it. What next - more attacks on freedom of speech, a return of masking, another forced vaccination campaign?
...
I wouldn't want to take your time up, only I have received these home testing kits that you so kindly sent out, and I have used one on my compost pile that I keep in my garden, and also the little fountain that I sit by when I have my morning coffee (when it isn't raining, that is). The test came back negative both times but I am still worried. There was lots of fuss during the last pandemic about how people who had negative test results might still have the coronavirus after all. Do you think you could maybe send out more test kits so that we can be sure? If we repeat the test twice and it comes back negative both times, we can be really sure that we're safe, right?
...
**Increasing Concerns Over Outbreak of `r dis_name` in `r city_name`**
...
To date there have been `r outbreak_deaths4A` deaths attributed to the pathogen, *`r inf_agent`*, and hundreds of people are currently ill with the disease.
...
There have been `r outbreak_deaths4A` deaths in the pandemic so far, but perhaps the most frightening aspect to this new pandemic is rumours that these Legionella strains may have become resistant to even more antibiotics - a truly chilling possibility.
