...
My son is a nurse at the `r hosp_name` and he has just been worked off his feet these last two weeks, quite frankly it is bringing back our PTSD from the COVID times and our mental health is struggling. It is so grand that you are finding extra resources and setting up all these extra clinics and testing facilities - I just wish something could be done to make sure that staffing was up to pace with this, and that our healthcare staff all have manageable workloads.
...
Now you are trying to say that in the name of "public health" we have to go back to working from home and following these ridiculous guidelines? What has happened to personal freedom in this country? It's become an absolute nightmare of a totalitarian regime.
...
I wouldn't want to take your time up, only I have some concerns about my nan in the care home, and whether I will be able to visit her any time soon. I wouldn't want to do so if it puts her at any risk at all, but on the other hand, if there's another lockdown, her mental health will really suffer again. I hope everything will be all right soon but I am still really worried. 
...
To date there have been `r outbreak_deaths4H` deaths attributed to the pathogen, *`r inf_agent`*, and hundreds of people are currently ill with the disease.

The city's Emergency Pandemic Response Committee is putting measures in place to deal with the pandemic, but the city is still worried about the potential for another lockdown. Memories of the COVID-19 lockdowns are fresh in everyone's minds. 
...
The pandemic ravaging `r city_name` has claimed yet another victim. There have been `r outbreak_deaths4H` deaths in the pandemic so far, but perhaps the most tragic loss is `r obit1name` `r obit1surname` - at only `r obit1age`, the youngest victim that the pandemic has claimed.    
...
There have been `r outbreak_deaths4H` deaths in the pandemic so far, but perhaps the most frightening aspect to this new pandemic is rumours that these *`r inf_agent`* strains may have become resistant to even more antibiotics - a truly chilling possibility.
