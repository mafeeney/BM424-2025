...
I am so worried about this pandemic, it seems like there is lots of positive things that you all have done to help reduce the number of deaths, but I am not so old that I don't remember all the scandals surrounding PPE back when the COVID19 pandemic first was, and all the troubles we had back then! But it seems like there should be something more we can do, are we doomed to go through a cycle of pandemic after pandemic, always sitting at home and worrying about whether we will die?
...
And I don't meant to complain when you are out there saving lives, but my nan was due in for a knee replacement surgery that's been cancelled, she can barely walk due to the pain, I was hoping that you'd be able to do something to help the hospitals back up and functioning? We're aware that the pressures on the NHS aren't your fault entirely, but I can't bear the thought of my poor nan suffering for years and years more, it's hard enough as it is when it seems every bone in your body aches as you get older. 
...
My son is a nurse at the `r hosp_name` and he has just been worked off his feet these last two weeks, quite frankly it is bringing back our PTSD from the COVID times and our mental health is struggling. I know you have opened some new facilities and are trying to reduce the workload on staff, but it just doesn't seem to be quite enough. I know budgets are tight, but is there any way at all you can hire more staff? 
...
Now you are trying to say that in the name of "public health" we are imposing punitively harsh fines on companies and restaurants that are just following normal, standard practices? When is the last time you had your kitchen at home audited - I suppose you wouldn't be very happy if you had a fine for that, would you! I don't know how you expect businesses to stay open, and the economy of our fair city to survive, if you continue on this reckless path. 
...
I wouldn't want to take your time up, only I have heard about some of the restaurants being fined due to the current pandemic, and I am just real worried. My best friend Sarah works in a cafe, and if she loses her job, I just dread to think of what will happen to her and her family - her poor little girl is only 3 and already struggling with leukaemia, Sarah works every hour that the day sends just to try to afford private medical treatment for her. If she can't keep her job I just don't know what she will do. I hope you can find some sort of solution for the businesses and affected workers, it will be just heartbreaking if the cafes need to close because of this. We already lost so many businesses during the COVID pandemic, I just don't know where we will go or how anyone will be able to afford to eat, given the cost of living crisis and all the problems you see nowadays. 
...
The situation appears to be improving in `r city_name`, but we are still seeing cases in this new disease outbreak that is coming hard on the heels of the COVID pandemic which began nearly five years ago. 

To date there have been `r outbreak_deaths4E` deaths attributed to the pathogen, *`r inf_agent`*, and hundreds of people are currently ill with the disease.

The city's Emergency Pandemic Response Committee seems to be taking all the right actions, and have instituted a number of public health measures - these include enforcing food safety measures, microbiological testing, and public safety announcements. (You do have to worry about the restaurants that were flauting these common sense safety measures to begin with!)
...
The pandemic ravaging `r city_name` has claimed yet another victim. There have been `r outbreak_deaths4A` deaths in the pandemic so far, but perhaps the most tragic loss is `r obit1name` `r obit1surname` - at only `r obit1age`, the youngest victim that the pandemic has claimed.    
...
Governments across the globe have seen how successful power-grabs in the name of public health can be, following on the wave of restrictions imposed because of so-called viral diseases like COVID-19 and "mpox". So-called scientists are fearmongering - aerosols, monkeys, "bird" flu - now they think that they can fool us into thinking that the air and water are unsafe. Citizens of `r city_name` should stand strong against this terrible tyranny! No more mask mandates, no more fines, no more senseless restrictions!

It is an absolute common sense outrage that businesses are being forced to shut and gyms are being closed with the excuse of this "public health emergency" - if the city council actually cared about public health, they would keep gyms open! Exercise is healthy (the mind-rotting TikTok obsession that has fuelled this obsession with so-called "pandemics" is not! When are these fools going to wake up and realise that they've been sold a pack of lies? You can tell that they've seriously been blue-pilled if they are so delusional that they think closing gyms is a reasonable course of action to protect peoples' health!)

Our businesses should be allowed to thrive, not dragged down with useless "safety measures" that have been already shown to be ineffective and costly. Our elders should not be left to die alone, left frightened and hopeless in a mandatory lockdown claimed to be "for their benefit." Our children should not be left to struggle through "pandemic" after "pandemic" - their language and literacy skills have been left behind due to these lockdowns, and their mental health is suffering. It is time that we take back control of our lives and end this tyranny of fear-mongering and so-called science. Citizens of `r city_name`, stand with me and resist this most recent attack on your freedoms and your lives. 
...
Hard on the heels of the COVID-19 pandemic and a number of other health scares (monkeypox, or "mpox", avian flu, and worries about other infectious disease outbreaks), another pandemic has hit the Scottish town of `r city_name`. This time, it's *`r inf_agent`*, a bacterium that can very sadly be fatal.

Hard on the heels of the COVID-19 pandemic and a number of other health scares (monkeypox, or "mpox", avian flu, and worries about other infectious disease outbreaks), another pandemic has hit the Scottish town of `r city_name`. This time, it's *`r inf_agent`*, a bacterium that can very sadly be fatal.

There have been `r outbreak_deaths4E` deaths in the pandemic so far, but perhaps the most frightening aspect to this new pandemic is rumours that these *`r city_name`* strains may have become resistant to even more antibiotics - a truly chilling possibility.
...
Some of the *`r inf_agent`* strains found in `r city_name` are reportedly resistant to all clinically available antibiotics, and scientists warn that these drug-resistant pathogens might be able to spread to new locations. Will nearby towns be next, or could these *`r city_name`* strains go as global as the SARS-COV2 virus did?
